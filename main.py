...
app.config["SECRET_KEY"] = "SD'GKIFGLDF;JGHFDIKHBFDOGHUFKDHGLKDF2_FFf1000-7"
db = SQLAlchemy(app)
admin = Admin(app)
...
def new_post():
    if request.method == "POST":
        ...
        categoroies = Category.query.all()
        return render_template("new_post.html", categories=categoroies)
